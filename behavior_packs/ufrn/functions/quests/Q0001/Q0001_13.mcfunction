...
# Leste
execute if block 323.50 -12.00 286.50 minecraft:polished_blackstone_button["button_pressed_bit"=true,"facing_direction"=1] run function event/on_subphase_complete
# Oeste
