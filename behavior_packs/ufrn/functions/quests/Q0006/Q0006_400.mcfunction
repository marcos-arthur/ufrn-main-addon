...
execute if score ufrn:subphase_tick ufrn >= ufrn:subphase_tick ufrn run execute positioned -256.69 -10.00 -574.49 unless entity @a[tag=Q0006_01,r=2,rm=0] run scoreboard players set ufrn:subphase ufrn 3
execute if score ufrn:subphase_tick ufrn >= ufrn:subphase_tick ufrn run execute positioned -256.69 -10.00 -574.49 if entity @a[tag=Q0006_01,tag=Q0006_03,r=2,rm=0] run scoreboard players set ufrn:subphase ufrn 3
