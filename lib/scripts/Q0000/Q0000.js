...
const intialPrisonCoord = { x: 218, y: -8, z: 190 };
export default class Quest0000 {
    static runQuest() {
        ...
        Utilities.getPlayersInVolume({ x: 248, y: -9, z: 150 }, 2, ["Q0000"], ["Q0000_05", "Q0000_06"]).forEach((player) => {
